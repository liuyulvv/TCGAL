...
pub fn is_segment_2_segment_2_intersected<T: NumberType>(
    line_segment_a: &LineSegment2<T>,
    line_segment_b: &LineSegment2<T>,
) -> bool {
...
pub fn segment_2_segment_2_intersection<T: NumberType>(
    ...
    if is_segment_2_segment_2_intersected(line_segment_a, line_segment_b) {
        if is_point_2_on_segment_2(&line_segment_a.source(), line_segment_b) {
            result.push(line_segment_a.source());
        }
        if is_point_2_on_segment_2(&line_segment_a.target(), line_segment_b) {
            result.push(line_segment_a.target());
        }
        if is_point_2_on_segment_2(&line_segment_b.source(), line_segment_a) {
            result.push(line_segment_b.source());
        }
        if is_point_2_on_segment_2(&line_segment_b.target(), line_segment_a) {
...
mod tests {
    ...
    fn test_is_segment_2_segment_2_intersected() {
        ...
        assert_eq!(
            is_segment_2_segment_2_intersected(&line_segment_a, &line_segment_b),
            true
        );
    ...
    fn intersection() {
        ...
        let result = segment_2_segment_2_intersection(&line_segment_a, &line_segment_b);
